...
public class CustomCommandPage extends HelpPage {
    public CustomCommandPage() {
        super("custom-commands-guide");
        addMessages(
                HelpComponent.of(
                        XG7Lobby.getInstance(),
                        "&m-&9&m-&6&m------------------&e*&6&m------------------&9&m-&f&m-"
                ).build(),
                new CustomCommandPageComponent(),
                HelpComponent.empty(),
                HelpComponent.of(
                        XG7Lobby.getInstance(),
                        "lang:[help.chat.back]"
    ...
    private class CustomCommandPageComponent extends HelpComponent {
        public CustomCommandPageComponent() {
